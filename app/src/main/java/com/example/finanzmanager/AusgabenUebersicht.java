...
public class AusgabenUebersicht extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ausgaben_uebersicht);

        Spinner spinner = findViewById(R.id.spinnerMonth);
        Spinner spinner1 = findViewById(R.id.spinnerYear);
        try {
