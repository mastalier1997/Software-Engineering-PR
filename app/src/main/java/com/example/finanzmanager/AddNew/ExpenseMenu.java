...
public class ExpenseMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (adapterView.getItemAtPosition(position).equals("Ausgaben")){
                    ...
                    if (adapterView.getItemAtPosition(position).equals("Einahmen")){
                        Intent intent = new Intent(ExpenseMenu.this, IncomeMenu.class);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(ExpenseMenu.this, NewExpense.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
            Intent intent = new Intent(ExpenseMenu.this, MainActivity.class);
            startActivity(intent);
