    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                month=month-1;
                datePickerDialog = new DatePickerDialog(NewIncome.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                public void onClick(View view) {
                    switch (add.getText().toString()){
                        ...
                        default://Betrag abspeichern
                            ...
                            if (repeats && MainActivity.account.repeatingIncomeContains(description, addNumber)) {
                                //Toast Message
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(NewIncome.this, IncomeMenu.class);
                startActivity(intent);
            }
        });
    }
