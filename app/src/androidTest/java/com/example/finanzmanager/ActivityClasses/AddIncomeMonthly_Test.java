...
public class AddIncomeMonthly_Test {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void addIncomeMonthly_Test() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editText_description_income),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("Arbeit"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.editText_description_income),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("Aktie"), closeSoftKeyboard());

        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.editText_description_income), withText("Aktie"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
